...
namespace Mvcschoolprjt.Controllers
{
    public class Class1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "classId,className,classFloor")] Class1 class1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "classId,className,classFloor")] Class1 class1)
        {
            if (ModelState.IsValid)
            {
